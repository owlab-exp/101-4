...
public class CallQuieterIntentService extends IntentService {
    ...
    private static final String ACTION_QUIETER_ON = "com.owlab.callblocker.service.action.QUIETER_ON";
    private static final String ACTION_QUIETER_OFF = "com.owlab.callblocker.service.action.QUIETER_OFF";
